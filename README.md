...
ALLOWED_MODELS=text:gemini-2.5-flash:text,flash:gemini-2.5-flash:text,pro:gemini-2.5-pro:text,image:imagen-3.0-generate-002:image,image-to-image:gemini-2.5-flash-image:image-to-image,audio:gemini-2.5-flash:audio,video:gemini-2.5-flash:video
