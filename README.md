...
| `image-to-image-preview` | `gemini-2.5-flash-image-preview` | image-to-image | Edición multi-imagen con Vertex AI |
...
El alias `image-to-image-preview` usa Vertex AI con `gemini-2.5-flash-image-preview` en ubicación `global`, sin API keys adicionales.
